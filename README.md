...
<script src="https://cdn.jsdelivr.net/gh/Github-SNI/scalability-sdk@v2.2/sdk/scale-analytics.min.js"></script>
<script src="https://cdn.jsdelivr.net/gh/Github-SNI/scalability-sdk@v2.2/sdk/scale-sdk-v2.min.js" defer></script>
```
...
<script
  src="https://cdn.jsdelivr.net/gh/Github-SNI/scalability-sdk@v2.2.0/sdk/scale-analytics.js"
  integrity="sha384-ATdZTGsaW1/CfOKOyZNcBcyrTaCXtdDI7JnHTWbgh5sKrz3RSqGYY4xlTQuYFMAL"
  crossorigin="anonymous"></script>
<script
  src="https://cdn.jsdelivr.net/gh/Github-SNI/scalability-sdk@v2.2.0/sdk/scale-sdk-v2.js"
  integrity="sha384-4dd3tZxTordLdHdJjJ0hrH8DLk9QbTOuHavqcjObhtkLi07GZcroGQnvOhOpuZwb"
...
```html
<script
  src="https://cdn.jsdelivr.net/gh/Github-SNI/scalability-sdk@v2.2.0/sdk/scale-analytics.min.js"
  integrity="sha384-C95tlgQf4ON9fdiOmJ1B1vee/4r8hmIlyNSODV1sBlXy2UBnhD5f9IS/IPdB1l2z"
  crossorigin="anonymous"></script>
<script
  src="https://cdn.jsdelivr.net/gh/Github-SNI/scalability-sdk@v2.2.0/sdk/scale-sdk-v2.min.js"
  integrity="sha384-aKa9+75PI20fbVcZ7DnCxQsqlHOkjAw3Cf2bpaX1xhAiAJeqn80DD2Y3XttFVrj3"
  crossorigin="anonymous"
  defer></script>
```
<!-- CDN-MIN-SNIPPET:END -->
...
### Specific version
```
https://github.com/Github-SNI/scalability-sdk/releases/download/v2.2.0/Scalability-SDK-v2.2.0.zip
```

### Individual file
```
https://github.com/Github-SNI/scalability-sdk/releases/download/v2.2.0/scale-sdk-v2.js
```
